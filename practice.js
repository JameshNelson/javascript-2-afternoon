...
*/
var favoriteThings = {band:"foo fighters", food:"yes", person:"Charity", book:"Yes", movie:"Venom", holiday:"Halloween"}
//Code here
...
favoriteThings.brand = "I don't care";
...
*/
var methodCollection = {alertHello: function(){
  alert("hello");
},
logHello: function(){
  console.log("hello"); 
...
function makeCard(cardNumber, expirationDate, securityCode){
  var newObj = {cardNumber: cardNumber, expirationDate: expirationDate, securityCode: securityCode};
  return newObj
}
//Code Here
